      ...
      <header className="py-2 md:px-40 flex items-center font-bold justify-between">
        ...
        <Link to={"/"}>
          <svg
            ...
            className="w-[50%]"
          >
            <g fill="white" className="svelte-1gcdbl9 text-white">
        ...
        >
          ...
          <button
            ...
            onClick={(e) => {
              ...
              if (password === pass2) {
                registrarUsuario();
                aviso.current.innerHTML = "";
              } else {
                aviso.current.innerHTML = "Ambas contraseñas deben ser iguales";
              }
            }}
          >
            Registrarse
          </button>
          <h4 className="text-red-500 text-center" ref={aviso}></h4>
        </div>
        <h2 className="text-white mt-5">
          Ya tienes una cuenta? {""}
          <Link to={"/login"} className="text-[#1ED660] font-bold">
            Inicia sesion
          </Link>
        </h2>
      </main>
