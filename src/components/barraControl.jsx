    ...
    <>
      ...
      <div className="bg-black py-3 fixed bottom-0 flex justify-center w-[100%] items-center px-5 gap-2">
        <figure className="w-[23%] md:w-[5%] flex items-center gap-5">
          ...
          <h1 className="text-gray-400 text-ellipsis hidden md:block w-[70%] whitespace-nowrap ">{nombre}</h1>
        </figure>
        ...
        {click ? (
          ...
          <svg onClick={()=>setClick(true)} className="w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path
              fill="#ff0000"
